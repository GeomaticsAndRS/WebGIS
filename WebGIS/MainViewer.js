define([
        './CesiumDir/Core/Cartesian3',
        './CesiumDir/Core/defined',
        './CesiumDir/Core/formatError',
        './CesiumDir/Core/Math',
        './CesiumDir/Core/objectToQuery',
        './CesiumDir/Core/queryToObject',
        './CesiumDir/DataSources/CzmlDataSource',
        './CesiumDir/DataSources/GeoJsonDataSource',
        './CesiumDir/DataSources/KmlDataSource',
        './CesiumDir/Scene/createTileMapServiceImageryProvider',
        './CesiumDir/Widgets/Viewer/Viewer',
        './CesiumDir/Widgets/Viewer/viewerCesiumInspectorMixin',
        './CesiumDir/Widgets/Viewer/viewerDragDropMixin',
        'domReady!'
    ], function(
        Cartesian3,
        defined,
